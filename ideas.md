...
All utility actions now read as celestial field notes rather than generic app controls: compact sky-expedition labels sit in parchment tabs or enamel instruments with fine-gold rules and compass-star details. The expedition route uses visible paper-cut platform seams, gilded drafting marks, softened castle shadows, and a route knight silhouette to keep the play world unmistakably handcrafted.
